...
class sHelper
{
    ...
    public static function followButton($following, $follower, $element, $size = ''){
        ...
        if ($relation){
            if ($relation->allow == 0) {
                return '<a href="javascript:;" class="btn btn-md btn--round btn-info fallowbtn request-button '.$size.'" onclick="follow(' . $following . ', ' . $follower . ', \''.$element.'\', \''.$size.'\')"></a>';
            }elseif ($relation->allow == 1){
                return '<a href="javascript:;" class="btn btn-md btn--round btn-info fallowbtn following-button '.$size.'" onclick="follow('.$following.', '.$follower.', \''.$element.'\', \''.$size.'\')"></a>';
            }
        }

        return '<a href="javascript:;" class="btn btn-md btn--round btn-info fallowbtn follow-button '.$size.'" onclick="follow('.$following.', '.$follower.', \''.$element.'\', \''.$size.'\')"><i class="fa fa-plus-circle"></i> Follow</a>';
    ...
    public static function deniedButton($me, $follower, $element, $size = ''){
        ...
        if ($relation){
            if ($relation->allow == 1) {
                return '<a href="javascript:;" class="btn btn-danger fallowdeletbtn '.$size.'" onclick="deniedFollow('.$me.', '.$follower.', \''.$element.'\', \''.$size.'\')" data-toggle="tooltip" title="Block">
                <i class="fa fa-ban"></i>
                </a>';
            }
        }
