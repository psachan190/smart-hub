...
<section class="content">
        <div class="info-box">
      	 <div class="col-sm-12">
            <div class="row">
              <div class="col-sm-6">
                 <a href="<?php echo url("addEvent"); ?>" class="btn btn-info"><i class="fa fa-plus" aria-hidden="true"></i>
            ...
            <div class="row" style="margin-top:30px;">
               <table class="table table-bordered"  id="userTbl">
                ...
                @if($result != FALSE)
                  ...
                  <td colspan="3"><a href="<?php echo url("editShopCategory/$list->id")?>" class="btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
