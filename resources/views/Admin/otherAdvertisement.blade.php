            ...
            <div class="row" style="margin-top:30px;">
               ...
               <?php
                if($vendorPostAds != FALSE){
                  ...
                  <td><?php if($listitem->paidStatus)echo $listitem->paidStatus; else{ echo $listitem->paidStatus; } ?></td>
                  <td colspan="3"><a href="<?php echo url("viewuserAdsPostDetails")."/".base64_encode($listitem->id); ?>" class="btn btn-info"><i class="fa fa-eye"></i></a></td>
                </tr>
                	  <?php
					$i++;
					}
