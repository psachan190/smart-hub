...
<section class="content">
        <div class="info-box">
      	 <div class="col-sm-12">
            <div class="row">
              <a href='{{ url("kanpurize_advertisement") }}' class="btn btn-info"><i class="fa fa-list" aria-hidden="true"></i>
&nbsp; Back</a> 
            </div>
              ...
              <h3 class="panel-title"><?php if(!empty($vPostAdsDetails->vName))echo $vPostAdsDetails->vName; ?></h3>
                ...
                <div class="col-md-9 col-lg-9 "> 
                  <input type="hidden" name="vAdsID" id="vAdsID" value="<?php if(!empty($vPostAdsDetails->id)) echo $vPostAdsDetails->id; ?>"> 
                   ...
                   <div style="">
             <?php 
			 if($vPostAdsDetails->applyFilteration=="yes"){
				?>
				 <p><strong>Apply Filteration :</strong></p>
                 <?php
                   if(!empty($vPostAdsDetails->applyFilteration)){
					   ?>
					    <p class=""><strong>Gender :</strong></p>
                        <p class=""><?php echo $arr[$vPostAdsDetails->gender]; ?></p>
					   <?php
					 }
				 ?>
                 <?php
                   if(!empty($vPostAdsDetails->ageFrom)){
					   ?>
					    <p class=""><strong>Age Difference :</strong></p>
                        <p class="">From : <?php echo $vPostAdsDetails->gender; ?></p>
                        <p class="">To : <?php echo $vPostAdsDetails->ageTo; ?></p>
					   <?php
					 }
				 ?>
                  <?php
