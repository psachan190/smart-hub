                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="contact_form--wrapper">
                                            ...
                                            <form action="<?php echo url("registrationShopAction"); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                                                <div class="row">
                                                	<div class="col-lg-12 col-md-12 ">
                            <div class="form-group">
                                <input type="hidden" name="users_id" id="users_id" placeholder="Shop Name" value="@if(!empty(session()->get('knpUser_id'))){{ session()->get('knpUser_id') }}@endif" />
                            </div>
                        </div>
                                                    <div class="col-lg-12 col-md-12 ">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12 col-md-12" style="display:none;">
                                                        <div class="form-group">
                                                             <input type="" name="vEmail" id="vEmail" placeholder="Email address" value="@if(!empty(session()->get('knpUser_email'))){{ session()->get('knpUser_email') }}@endif " readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
