...
<section class="hero-area bgimage">
    <div class="bg_image_holder">
        <img src="{{ asset('public/images/hero_area_bg1.jpg') }}" alt="background-image">
    </div>
    <!-- start hero-content -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="hero__content__title">
                            ...
                            <p class="tagline">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium</p>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="feature">
                    <div class="feature__img">
                        <img src="{{ asset('public/images/feature1.png') }}" alt="feature">
                    </div>
            ...
            <div class="col-md-4">
                <div class="feature">
                    <div class="feature__img">
                        <img src="{{ asset('public/images/feature2.png') }}" alt="feature">
                    </div>
                    <div class="feature__title">
            ...
            <div class="col-md-4">
                <div class="feature">
                    <div class="feature__img">
                        <img src="{{ asset('public/images/feature3.png') }}" alt="feature">
                    </div>
                    <div class="feature__title">
                ...
                <div class="featured-product-slider prod-slider1">
                    <div class="featured__single-slider">
                        <div class="featured__preview-img">
                            <img src="{{ asset('public/images/featprod.jpg') }}" alt="Featured products">
                            <div class="prod_btn">
                        ...
                        <div class="featured__product-description">
                            <div class="product-desc desc--featured">
                                ...
                                <ul class="titlebtm">
                                    <li>
                                        <img class="auth-img" src="{{ asset('public/images/auth.jpg') }}" alt="author image">
                    ...
                    <div class="filter__menu">
                        ...
                        <div class="filter__menu_icon" >
                            <a href="#" id="drop1" class="dropdown-trigger" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="svg" src="{{ asset('public/images/svg/menu.svg') }}" alt="menu icon" >
                            </a>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="{{ asset('public/images/p1.jpg') }}" alt="Product Image">
                        <div class="prod_btn">
                            <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div><!-- end /.prod_btn -->
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="{{ asset('public/images/p2.jpg') }}" alt="Product Image">
                        <div class="prod_btn">
                            <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div><!-- end /.prod_btn -->
                    ...
                    <div class="product-desc">
                        ...
                        <ul class="titlebtm">
                            <li>
                                <img class="auth-img" src="{{ asset('public/images/auth2.jpg') }}" alt="author image">
                                <p><a href="#">AazzTech</a></p>
                            </li>
                            <li class="product_cat">
                                <a href="#"><span class="lnr lnr-book"></span>Plugin</a>
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="{{ asset('public/images/p3.jpg') }}" alt="Product Image">
                        <div class="prod_btn">
                            <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div><!-- end /.prod_btn -->
                    ...
                    <div class="product-desc">
                        ...
                        <ul class="titlebtm">
                            <li>
                                <img class="auth-img" src="{{ asset('public/images/auth3.jpg') }}" alt="author image">
                                <p><a href="#">AazzTech</a></p>
                            </li>
                            <li class="product_cat">
                                <a href="#"><span class="lnr lnr-book"></span>Plugin</a>
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="{{ asset('public/images/p4.jpg') }}" alt="Product Image">
                        <div class="prod_btn">
                            <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div><!-- end /.prod_btn -->
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="{{ asset('public/images/p5.jpg') }}" alt="Product Image">
                        <div class="prod_btn">
                            <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div><!-- end /.prod_btn -->
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <div class="product product--card">
                    ...
                    <div class="product__thumbnail">
                        <img src="{{ asset('public/images/p6.jpg') }}" alt="Product Image">
                        <div class="prod_btn">
                            <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                            <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                        </div><!-- end /.prod_btn -->
...
<section class="counter-up-area bgimage">
    <div class="bg_image_holder">
        <img src="{{ asset('public/images/countbg.jpg') }}" alt="">
    </div>
    <!-- start .container -->
        ...
        <div class="row">
            <div class="col-md-6 no-padding">
                <div class="proposal proposal--left bgimage">
                    <div class="bg_image_holder">
                        <img src="{{ asset('public/images/bbg.png') }}" alt="prop image">
                    </div>
                    <div class="content_above">
                        <div class="proposal__icon ">
                            <img src="{{ asset('public/images/buy.png') }}" alt="Buy icon">
                        </div>
            ...
            <div class="col-md-6 no-padding">
                <div class="proposal proposal--right">
                    <div class="bg_image_holder">
                        <img src="{{ asset('public/images/sbg.png') }}" alt="this is magic">
                    </div>
                    <div class="content_above">
                        <div class="proposal__icon">
                            <img src="{{ asset('public/images/sell.png') }}" alt="Sell icon">
                        </div>
                        <div class="proposal__content ">
                ...
                <div class="testimonial-slider">
                    <div class="testimonial">
                        <div class="testimonial__about">
                            <div class="avatar v_middle"><img src="{{ asset('public/images/test1.jpg') }}" alt="Testimonial Avatar"></div>
                    ...
                    <div class="testimonial">
                        <div class="testimonial__about">
                            <div class="avatar v_middle"><img src="{{ asset('public/images/test2.jpg') }}" alt="Testimonial Avatar"></div>
                            <div class="name-designation v_middle">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="news">
                    <div class="news__thumbnail">
                        <img src="{{ asset('public/images/news1.png') }}" alt="News Thumbnail">
                    </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="news">
                    <div class="news__thumbnail">
                        <img src="{{ asset('public/images/news2.png') }}" alt="News Thumbnail">
                    </div>
                    <div class="news__content">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="special-feature feature--1">
                    <img src="{{ asset('public/images/spf1.png') }}" alt="Special Feature image">
            ...
            <div class="col-md-6">
                <div class="special-feature feature--2">
                    <img src="{{ asset('public/images/spf2.png') }}" alt="Special Feature image">
...
<section class="call-to-action bgimage">
    <div class="bg_image_holder">
        <img src="{{ asset('public/images/calltobg.jpg') }}" alt="">
    </div>
    <div class="container content_above">
        <div class="row">
            <div class="col-md-12">
