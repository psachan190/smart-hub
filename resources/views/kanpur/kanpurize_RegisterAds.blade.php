        ...
        <div class="container">
             <div class="row orderrow">
              <div class="col-sm-12">
                     ...
                     <form id="offerandNewsPostForm" class="orderInform">
                    <?php echo csrf_field(); ?>
                        <div class="cardify login">
                           ...
                           <input type="hidden" name="paidStatus" id="v"  value="unpaid"  />
                                        ...
                                        <tbody>
                                         @if($getUserAds != FALSE)
                                           @php $i=1 @endphp
                                            ...
                                            <th>@if(!empty($dataArr->startDate)){{ $dataArr->startDate }}@endif</th>
                                            <th>@if(!empty($dataArr->endDate)){{ $dataArr->endDate }}@endif</th>
                                            <th>@if(!empty($dataArr->paidStatus)){{ $dataArr->paidStatus }}@endif</th>
                                            <th>@if($dataArr->adminStatus=="Y"){{ "Approve" }} @else {{ "pending" }} @endif</th>
                                            <th><a href='{{ url("kanpurize_user_AdsDetails/$id") }}'>Details</a></th>
                                             </tr>
                                            @php $i++ @endphp 
                                           @endforeach
                                         @endif
