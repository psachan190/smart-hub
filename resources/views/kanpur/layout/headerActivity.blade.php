                    ...
                    <div class="author-area">
                        ...
                        <div class="author__notification_area">
                            <ul>
								...
								<li class="has_dropdown">
                                    <div class="icon_wrap">
                                        <span class="lnr lnr-cart"></span> <span class="notification_count purch"><span id="cartCount"><?php if(!empty($cartCount))echo $cartCount; else echo "0";  ?></span></span>
                                    </div>
                                             ...
                                             <div>
                                              <div class="cart_product">
                                                <div class="product__info">
                                                    ...
                                                    <div class="info">
                                                        <a class="title" href="#">Finance and Consulting Business Theme</a>
                        ...
                        <div class="offcanvas-menu closed">
                            ...
                            <div class="dropdown dropdown--author">
                                <ul>
                                    ...
                                    <li><a href="#"><span class="lnr lnr-upload"></span>Upload Item</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <nav class="navbar navbar-default mainmenu__menu dashboard_menu_area">
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                               <li><a href="#"><span class="lnr lnr-home"></span> Dashboard</a></li>
                            <li><a href="#"><span class="lnr lnr-cog"></span> Vidio</a></li>
                            <li><a href="#"><span class="lnr lnr-cart"></span> Singing</a></li>
                            <li><a href="#"><span class="lnr lnr-dice"></span> Audio</a></li>
                            <li><a href="#"><span class="lnr lnr-chart-bars"></span> Dance</a></li>
                            </ul>
                        </div><!-- /.navbar-collapse -->
