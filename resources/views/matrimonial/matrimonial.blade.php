...
<section>
   ...
   <div class="row" id="metrimonialimg">
                     ...
                     <div class="information_wrapper form--fields">
                        ...
                        <div class="form-group" id="genderBlock">
                               ...
                               <div class="custom-radio"> 
                                ...
                                <label for="male"><span class="circle"></span>Male</label>&nbsp;&nbsp;
     ...
     <label>Date of Birth<sup>*</sup> </label>
                        ...
                        <div class="col-sm-12">
                        <div class="form-group">
                                <label for="interested">I am interested in <sup>*</sup></label>
                                <div class="custom-radio"> 
                                <input type="radio" id="interested_male" name="interestedGender" value="M" />                                <label for="interested_male"><span class="circle"></span>Male</label>&nbsp;&nbsp;
                                 <input type="radio" id="interested_female" name="interestedGender" value="F" />
                                 <label for="interested_female"><span class="circle"></span>Female &nbsp;</label> 
                                 <small class="text-danger">{{ $errors->first('interestedGender') }}</small>
                                </div>
                       </div>
                        </div>
                         <div class="col-sm-12">
                        <div class="form-group">
                                <label for="aboutProfile">About Profile<sup>*</sup></label>
