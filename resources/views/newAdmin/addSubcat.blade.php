        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
               <form name="" id="" class="form-group col-sm-8" action="<?php echo url("admin/addsubCate"); ?>" method="post">
                      <?php echo csrf_field(); ?>
                     ...
                     <div class="form-group">
                       ...
                       <div class="">
                         <input type="text" id="scatname" name="scatname" value="" class="form-control" placeholder="Enter Sub Category Name" />
                       </div>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                       ...
                       <div class="">
                         <textarea name="subDesc" id="subDesc" placeholder="Sub Category Description" class="form-control" rows="5"></textarea>
                       </div>
                     </div>
                     <div class="form-group">
                       <label>Status</label>
