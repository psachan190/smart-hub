		...
		<div class="row" >
			...
			<div class="col-md-4 padding_div">
				...
				<div class="box box-widget">
					...
					<div class="box-footer box-comments" style="display: block;">
						<div class="box-commentreply">
							...
							<div class="comment-text">
								<p style=""><span class="namemsg"><strong>Mohit Sahu</strong>&nbsp;It is a long established fact that a reader will be distracted
									</span>
								</p>
								<span class="text-mutedr pull-left"><a class="textreply">Reply</a></span>
								<span class="text-mutedr pull-right">8:03 PM Today</span>
							</div>
						</div>
						<div class="box-footer textreplymsg box-commentreply">
							<img class="reply_img_size img-circle img-sm" src="{{ asset('cdn/images/back/food.jpg') }}" alt="User Image">
							<div class="comment-text">
								<p><span class="namemsg"><strong>Mohit Sahu</strong>&nbsp;It is a long established fact that
									</span>
								</p>
								<span class="text-mutedr pull-right">8:03 PM Today</span>
							</div>
					...
					<div class="box-footer comentbox">
						<form action="#" method="post">
							<img class="reply_img_size img-responsive img-circle img-sm" src="{{ asset('cdn/images/back/food.jpg') }}" alt="Alt Text">
							<div class="img-push">
						...
						<ul>
							<li class="swicss1 like-reaction">
								...
								<span class="like-btn">
									...
									<span class="like-btn-text">Rating</span> <!-- Default like button text,(Like, wow, sad..) default:Like  -->
									<ul class="reactions-box">
										<!-- Reaction buttons container-->
										<li class="reaction reaction-angry" data-reaction="Angry" data-reactionValue="1"></li>
										<li class="reaction reaction-sad" data-reaction="Sad" data-reactionValue="2"></li>
										<li class="reaction reaction-haha" data-reaction="Haha" data-reactionValue="3"></li>
										<li class="reaction reaction-love" data-reaction="Love" data-reactionValue="4"></li>
