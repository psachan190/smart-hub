   ...
   <div class="col-sm-12 col-md-6 col-lg-9" style="margin-top:33px;">
     <div class="post">
        <div class="content">
          ...
          <form id="editofferNewsForm" name="editofferNewsForm" autocomplete="off">
            <?php echo csrf_field(); ?>
                ...
                <input type="hidden" name="imageCopy" id="" value="{{ $offerNewsDetails->image }}" readonly="readonly" />
               ...
               <div class="row" style="margin-top:25px;">
                ...
                <div class="left-inner-addon">
                        ...
                        <input type="text" name="startDate" id="datepicker1" class="form-control" placeholder="dd/mm/yyyy"  value="{{ date('d-M-Y' , $offerNewsDetails->startDate ) }}" />
               </div>
                </div>
                <div class="col-sm-6 ">
                ...
                <div class="left-inner-addon">
                           <i class="glyphicon glyphicon-calendar"></i>
                        <input type="text" name="endDate" id="datepicker2" class="form-control" placeholder="dd/mm/yyyy"  value="{{ date('d-M-Y' , $offerNewsDetails->endDate) }}" />
               </div>
                </div>
              </div>
               <div class="row" style="margin-top:25px;">
                 ...
                 &nbsp;&nbsp;
                  <input type="text" name="newsTitle" id="newsTitle" class="form-control" placeholder="News &amp; Offers Title"  value="{{ $offerNewsDetails->newsTitle }}" />
               	...
               	<div class="row" style="margin-top:25px;">
                                    ...
                                    ;">optional ( if you sale any products in offer)</span></label>
               ...
               <div id="someDivToDisplayErrors"></div>
                <div class="col-sm-12">
                <div class="form-group">
              <button type="submit" name="submit" id="editNews" class="btn btn-md btn--icon btn--round"><i style="color:#FFF;" class="fa fa-edit"></i>&nbsp;Edit News</button>  
            </div>
...
$(document).ready(function(e) {
 $.ajaxSetup({
  ...
  $(document).on('submit',"#editofferNewsForm",(function(e) {
	...
	e.preventDefault();
      $.ajax({
      url: "<?php echo url("vendorAgax/editNewsoffer"); ?>",
      type: "POST",        
