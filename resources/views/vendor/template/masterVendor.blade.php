...
<div class="menu-area">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-7 v_middle">
                    <div class="logo">
                        <a href="<?php echo url("kanpurizeMarketplace"); ?>"><img src="{{ asset('images/logo1.png') }}" alt="Kanpurize Login"></a>
                    </div>
                </div><!-- end /.col-md-3 -->
                <!-- start .col-md-5 -->
                            ...
                            <ul>
                                ...
                                <img src="{{ asset('images/icon/share.png') }}" />
                                        ...
                                        <ul class="dropdown dropshare messaging_dropdown dropdown-menu" aria-labelledby="drop2">
                                                ...
                                                <li><a target="_blank" href="https://plus.google.com/share?url=https://kanpurize.com/shareWebshop/<?php echo $vresultData->id;?>?shopRfeid=<?php echo $vresultData->id; ?>"><span class="fa fa-google-plus"></span>&nbsp;Google Plus</a></li>
                        ...
                        <div class="offcanvas-menu closed">
                            ...
                            <div class="author__notification_area">
                                    <ul>
                                        ...
                                        <li>
                                            <a target="_blank" class='wa_btn wa_btn_s' href="https://whatsapp.com/send?text=https://kanpurize.com/shareWebshop/<?php echo $vresultData->id;?>?shopRfeid=<?php echo $vresultData->id; ?>">
                                                <div class="icon_wrap">
    ...
    <!-- start .mainmenu_area -->
 <?php
   if(!empty($vresultData->paymentStatus == "Y")){
       ?>
	   <div class="mainmenu">
        <!-- start .container -->
        <div class="container">
            ...
            <div class="row">
				...
				?>
                               <li class="has_dropdown">
                                    ...
                                    <div class="dropdown dropdown--menu">
                                            <ul>
                                                ...
                                                <li><a href="<?php echo url("approvePost"); ?>">Approved Post Ads</a></li>
                                            </ul>
                                        </div>
                                </li>
                               <li class="has_dropdown">
                               ...
                               <li><a href="<?php echo url("uesrsComplain"); ?>">Uesrs Enquiry</a></li>
